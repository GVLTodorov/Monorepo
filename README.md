...
|---|---|---:|---:|
| `Mongo.Tests` | NUnit 4.6.1, Moq 4.20.72 | 57 passing tests | No |
| `Postgres.Tests` | NUnit 4.6.1, Microsoft.Data.Sqlite | 45 passing tests | No |
| `Sqlite.Tests` | NUnit 4.6.1, Microsoft.Data.Sqlite | 45 passing tests | No |

The latest solution run passed all 147 tests.

### Test coverage

Coverage numbers below are regenerated by the [CI pipeline](https://github.com/GVLTodorov/Monorepo/actions/workflows/ci.yml) on every push to `main` — see a specific run's results there.

<!-- coverage:start -->
Coverage was collected on 2026-09-04 from all 147 passing tests with Coverlet's Cobertura collector. Test and benchmark assemblies are excluded, and automatically generated property accessors are skipped.

| Production library | Line coverage | Branch coverage | Covered lines | Covered branches |
|---|---:|---:|---:|---:|
| MongoDB | 98.91% | 93.75% | 452 / 457 | 150 / 160 |
| PostgreSQL | 97.97% | 96.08% | 819 / 836 | 490 / 510 |
| SQLite | 97.98% | 96.06% | 823 / 840 | 488 / 508 |
| **Overall** | **98.17%** | **95.76%** | **2,094 / 2,133** | **1,128 / 1,178** |
<!-- coverage:end -->
